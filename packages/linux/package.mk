...
PKG_DEPENDS_TARGET="toolchain linux:host cpio:host kmod:host xz:host wireless-regdb keyutils ncurses $KERNEL_EXTRA_DEPENDS_TARGET"
...
case "$LINUX" in
  amlogic-3.14)
    ...
    ;;
  amlogic-4.9)
	PKG_VERSION="60336a60e8060461f515199c5fc182e392a9750e"
    PKG_SHA256="86357dae0621397b7359e24b0803c13771daeea41d3fc4a6e4bd8e8283937487"
    PKG_URL="https://github.com/CoreELEC/linux-amlogic/archive/$PKG_VERSION.tar.gz"
    PKG_SOURCE_NAME="linux-$LINUX-$PKG_VERSION.tar.gz"
    PKG_DEPENDS_TARGET="$PKG_DEPENDS_TARGET aml-dtbtools:host"
