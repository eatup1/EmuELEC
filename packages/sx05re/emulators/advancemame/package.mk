...
if [ "${DEVICE}" == "OdroidGoAdvance" ]; then
   ...
   cp -r ${PKG_DIR}/config/advmame.rc_rg351p ${INSTALL}/usr/config/emuelec/configs/advance/advmame.rc
elif [ "${DEVICE}" == "RG351V" ]; then
   cp -r ${PKG_DIR}/config/advmame.rc_rg351v ${INSTALL}/usr/config/emuelec/configs/advance/advmame.rc
